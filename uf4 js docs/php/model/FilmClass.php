...
class FilmClass implements EntityInterface {
    private $id;
    private $idFilmType;
    private $idDirector;
    private $name;
    ...
    public function toString() {
        $toString = "filmClass[id=" . $this->id . "][idFilmType=" . $this->idFilmType . "][idDirector=" . $this->idDirector . "][name=" . $this->name . "][price=" . $this->price . "][image=" . $this->image . "][inSale=" . $this->inSale . "][rented=" . $this->rented . "]";
		return $toString;
