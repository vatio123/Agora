...
class ReviewClass implements EntityInterface {
    private $id;
    private $idFilm;
    private $dateReview;
    private $rate;
    ...
    public function toString() {
        $toString = "reviewClass[id=" . $this->id . "][idFilm=" . $this->idFilm . "][dateReview=" . $this->dateReview . "][rate=" . $this->rate . "][desciption=" . $this->description . "]";
		return $toString;
